...
<style>
  ...
  .topic-btn { display:inline-block; padding:3px 330px; border-radius:999px;
...
[EDA](../content/01-EDA.qmd){.topic-btn .step1}  click to open
...
[EVL](../content/05-EVAL.qmd){.topic-btn .step5} click to open
...
[CLS](../content/03-ALG.qmd#cls){.topic-btn .step3} click to open
...
[DATA](../content/02-DATA.qmd){.topic-btn .step2} click to open

|||
|:---:|:---|:---|
| T Oct 20 |  [DATA1](../content/02-DATA.qmd#slides){.ag-btn .ag-grey} [Quiz: CLS](../content/03-ALG.qmd#cls-standards){.ag-btn .step3} | Sign-up for retakes if applicable |
...
[TREE](../content/03-ALG.qmd#tree){.topic-btn .step3} click to open
